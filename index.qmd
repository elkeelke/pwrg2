...
@susca2012enhancement proposed an enhancement of the LCA methodology with a time-dependent climatological model for including the effect of surface albedo on climate. They evaluate their theoretical findings derived with a case study of a black and a white roof evaluated over the time frames of 50 and 100 years. The comparative life cycle impact assessment of the two roofs shows that the high surface albedo plays a crucial role in offsetting radiative forcings. 

## Albedo and PV and LCA

Several studies on the surface albedo change effects from PV installations exist in literature. @nemet2009net found that the avoided emissions effect from PV generated energy is far greater than the observed warming effect from the related albedo reduction.
