...
A promising area where such data might be applied is for the evaluation of changes in surface reflectivity associated with the installation of photovoltaic panels (PV) which can be assessed from the relevant satellite data before and after the installation of the PV sites under study. There might be a net positive, neutral, or net negative effect. For most cases a net positive effect is expected. The change in surface albedo caused by replacing natural or built surfaces with PV panels is expected to represent a significantly smaller environmental impact compared to the environmental benefits of solar power over non-renewable energy sources. However, it still constitutes a measurable effect that can potentially be quantified and incorporated into LCAs. 
...
The structure of the project work is as follows. Following the introduction, a review of existing literature on the incorporation of albedo changes into LCA, as well as the use of remote sensing–based metrics to support this integration, will be presented. The central contribution of the work will be the design of a detailed research project plan aimed at addressing the defined research questions and at carrying out this research, including methodological steps, project milestones, and a time plan.
