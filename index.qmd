...
The accuracy of satellite-derived data is crucial. Many scientific publications are focused on accurately assessing accuracy levels and understanding the reasons for discrepancies:

*   @gruber2020validation propose good practice guidelines for the validation of global coarse-scale satellite soil moisture data sets and practical recommendations on data preprocessing and presentation of statistical results together with a recommended validation protocol and an example validation.
