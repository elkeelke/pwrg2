...
Other studies investigated the impact of PV on radiative forcing without considering LCA on several different PC installation sites such as city roofs, deserts, alpine locations, and lakes:
...
The conclusion is that on each of these surfaces, impacts on albedo caused by the PV installations could be observed. Several studies from the LCA research community have suggested to include these effects into LCAs: 
