...
Two related aspects are worth mentioning:
...
The goal of the research plan presented in this section is to address the research questions defined in @sec-research-questions.
...
### Albedo measurement and environmental impact assessment
...
Positive RF is the initial driver of climate change. It causes temperature rise in the atmosphere and on the earth surface (sea and land). Temperature rise causes ice-covered regions such as ice sheets, glaciers, and sea ice to melt. This is a positive feedback loop for further albedo changes, since bright surfaces are replaced by darker ones. Changes in surface albedo directly modify the shortwave component of the radiative balance. A reduction in albedo (e.g., replacing bright desert surface with dark PV panels) increases the absorption of solar energy, leading to positive radiative forcing (surface warming). Conversely, an increase in albedo contributes to negative radiative forcing (surface cooling). @tbl-ipcc revealed that the overall land use change related albedo change has a cooling effect.
...
Satellites and data sets mentioned in the literature study.

### Spatial and temporal data aggregation

What level of spatial and temporal data aggregation is required to obtain meaningful results, given the quality and resolution of the data?
...
### Original surface identification

Is it feasible to identify the original surface such as buildings, deserts, grasslands, croplands, water? 

### Albedo change by original surface type

Is it possible to assess and quantify the albedo change by original surface type? 
...
* Lay out if and how we can do it in an automated way for a larger amount of data.
