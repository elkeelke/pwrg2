...
## Albedo change per original surface
...
*  @hasler2024accounting finds that maximizing the climate benefits of tree-cover restoration requires accounting for albedo effects since they often offset or even reverse carbon removal gains, especially in dryland and boreal regions. Using spatial data, the study shows that carbon-only estimates may be up to 81% too high. While many projects target more climate-positive areas, most still face at least a 20% albedo offset. The study offers tools to identify where restoration delivers true net climate benefits.
