...
A promising area where such data might be applied is for the evaluation of changes in surface reflectivity associated with the installation of photovoltaic panels (PV). While the reduction in surface albedo caused by replacing natural or built surfaces with PV panels is expected to represent a significantly smaller environmental impact than the environmental benefits of solar power over non-renewable energy sources, it still constitutes a measurable effect that can potentially be quantified and incorporated into LCAs. 
...
The project proposal should be more structured including specific research questions.
...
I would expect very different Albedo changes for open ground PV compared to building mounted PV.
...
I would expect a different outcome here. PV will replace either naturally high or naturally low albedo surfaces depending on the site of installation. For buildings the integration of PV panels i would expect a neutral effect with the Albedo of building roof being similar to the Albedo of PV panels. There might be special cases e.g. where the building roofs a painted white, but for most cases the difference should not very relevant.
...
In general, it will be crucial to compare the before installation and after installation albedo for the PV sites under study. Depending on this comparison there might be a net positive, neutral of net negative effect. However for most of the cases a net positive effect is expected.

The structure of the project work is as follows. Following the introduction, a review of existing literature on the incorporation of albedo changes into LCA, as well as the use of remote sensing–based metrics to support this integration, will be presented. The central contribution of the work will be the design of a detailed research project plan aimed at addressing the defined questions and at carrying out this research, including methodological steps, project milestones, and a time plan.

The appendix will provide introductory overviews of life cycle assessment and satellite-based Earth observation for readers seeking background information on these topics.
...
Remote sensing, particularly through satellites, provides vast amounts of data. Satellites offer a unique, large-scale perspective for continuous observation of the Earth's surface and atmosphere. They collect data that can be directly or indirectly used to assess land cover, vegetation health, surface temperatures, atmospheric gases, and ocean characteristics. All of these are essential for understanding environmental trends and changes over time. Satellite derived Earth Observation (EO) data supports a wide range of applications, from climate modeling and disaster response to agricultural planning. In particular, EO data allows (1) to assess if a certain location is covered by a solar panel, and (2) measure the reflectivity in that location. Since EO data is continuously collected and available in archives (?), it is possible to go back in time and measure the reflectivity before the solar panel installation as a comparison point.

Albedo is the ratio of solar energy reflected by a surface. The energy that is not reflected is absorbed by the Earth's surface and converted into heat. This absorbed heat is energy that drives weather patterns, surface temperatures, and consequently, the climate system. Since PV installations typically replace natural high-albedo surfaces with much darker PV modules, this results in a net decrease in surface reflectivity and, in turn, higher energy balance. 
...
The lower reflectivity of PV panels reduces surface albedo. Plan a project to quantify this effect
