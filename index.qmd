...
Albedo is the ratio of solar radiation reflected by a surface to the amount incident upon it. It is a primary regulator of the energy balance and climate. Since PV installations typically replace natural high-albedo surfaces with much darker PV modules, this results in a net decrease in surface reflectivity. Earth Observation data allows (1) to assess if a certain location is covered by a solar panel, and (2) measure the reflectivity in that location.
