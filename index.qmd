...
![Conceptual framework for for assessing changes in surface albedo resulting from PV installations using satellite-derived data](img/PWRG 2 methodology.png){#fig-methodology fig-align="center" width="80%"}
...
Table: Compiled list of typical albedo values per surface type
:::
...
This is a dual use system for agriculture and energy production.

### System boundaries and diagram
