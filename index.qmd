...
While many scientific publications on PV and LCA overlook the effects of surface albedo change (such as @gerbinet2014life, @ferrara2024life, @gomez2024agile), only a limited number of studies have attempted to quantify the effect in a way that could be used as in input to an LCA. @nemet2009net estimated the effects of covering Earth with sunlight absorbing panels on a large scale and therefore reducing surface albedo. They found that avoided emissions from PV generated energy were far greater than the observed warming effect from the related albedo reduction. @wei2024small confirmed these results based on global satellite data showing that albedo induced positive radiative forcing can be offset by negative radiative forcing from clean solar generation in most PV farms within one year.
...
Environmental impacts of pastoral‑integrated photovoltaic power plant in an alpine meadow on the eastern Tibetan Plateau (2025)

Physical analysis of the environmental impacts of fishery complementary photovoltaic power plant (Environmental Science and Pollution Research, 2022)
