...
Remote sensing, in particular satellite-based Earth Observation, provides access to extensive datasets that hold potential for supporting life cycle assessments (LCAs) to evaluate environmental impacts across a product or service life cycle. One area where such data might be used is in the evaluation of changes in surface reflectivity associated with the installation of photovoltaic (PV) panels. While the reduction in surface albedo caused by replacing natural or built surfaces with PV panels is expected to represent a significantly smaller environmental effect in comparison to the environmental benefits of solar power over non-renewable energy sources, its effect remains measurable and can potentially be quantified and incorporated into LCAs.

This work serves as a case study for exploring how remote sensing data can be integrated into LCA frameworks. It is guided by two main research questions. First, how can satellite-derived remote sensing data be applied to assess changes in albedo resulting from PV installations? Second, how can such data be incorporated into LCAs in a methodologically sound and credible manner, enabling its authorative use in environmental impact assessments of solar energy systems?

The structure of the study is as follows. It will start out with introductory overviews of both life cycle assessment and satellite-based Earth Observation to establish a common foundation. This will be followed by a review of existing literature on the use of remote sensing data in LCA contexts. The central contribution of the work will be the design of a research approach aimed at addressing the defined questions. The final section will present a detailed plan for carrying out this research, including methodological steps and project milestones.
